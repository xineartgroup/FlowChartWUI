...
namespace FlowChart
{
	namespace Data
	{
		...
		const winrt::hstring &SymbolOr::getName() const
		{
			return privateName;
		}

		void SymbolOr::setName(const winrt::hstring &value)
		{
			privateName = value;
		}

		const winrt::hstring &SymbolOr::getCaption() const
		{
			return privateCaption;
		}

		void SymbolOr::setCaption(const winrt::hstring &value)
		{
			privateCaption = value;
		}

		const bool &SymbolOr::getIsSelected() const
		{
			return privateIsSelected;
		}

		void SymbolOr::setIsSelected(const bool &value)
		{
			privateIsSelected = value;
		}

		const bool &SymbolOr::getIsHover() const
		{
			return privateIsHover;
		}

		void SymbolOr::setIsHover(const bool &value)
		{
			privateIsHover = value;
		}

		const bool &SymbolOr::getIsEditing() const
		{
			return privateIsEditing;
		}

		void SymbolOr::setIsEditing(const bool &value)
		{
			privateIsEditing = value;
		}

		winrt::hstring SymbolOr::getIconName()
		{
			return L"imgOr.png";
		}

		const winrt::Windows::UI::Color &SymbolOr::getLineColor() const
		{
			return privateLineColor;
		}

		void SymbolOr::setLineColor(const winrt::Windows::UI::Color& value)
		{
			privateLineColor = value;
		}

		const winrt::Windows::UI::Color &SymbolOr::getFillColor() const
		{
			return privateFillColor;
		}

		void SymbolOr::setFillColor(const winrt::Windows::UI::Color &value)
		{
			privateFillColor = value;
		}

		const winrt::Windows::UI::Color &SymbolOr::getFontColor() const
		{
			return privateFontColor;
		}

		void SymbolOr::setFontColor(const winrt::Windows::UI::Color &value)
		{
			privateFontColor = value;
		}

		const System::Drawing::Font &SymbolOr::getTextFont() const
		{
			return privateTextFont;
		}

		void SymbolOr::setTextFont(const System::Drawing::Font &value)
		{
		...
		int SymbolOr::GetInputAnchorCount()
		{
			return 3;
		}

		int SymbolOr::InputAnchorHit()
		{
		...
		float SymbolOr::GetWidth()
		{
			return width;
		}

		float SymbolOr::GetHeight()
		{
			return height;
		}

		void SymbolOr::Draw(Canvas canvas)
		{
			width = height;
			...
			points[3].Y = GetPosition().Y + (GetHeight() / 2);
		...
		void SymbolOr::SetPosition(float x, float y)
		{
			xPos = x;
			yPos = y;
		}

		winrt::Windows::Foundation::Point SymbolOr::GetPosition()
		{
			return winrt::Windows::Foundation::Point(xPos, yPos);
		}

		std::vector<AnchorPoint*> SymbolOr::GetInputAnchorPoints()
		{
		...
		std::vector<AnchorPoint*> SymbolOr::GetOutputAnchorPoints()
		{
		...
		AnchorPoint* SymbolOr::GetInputAnchorPoint(int anchorIndex)
		{
			std::vector<AnchorPoint*> list = GetInputAnchorPoints();
		...
		AnchorPoint* SymbolOr::GetOutputAnchorPoint(int OutputAnchorIndex)
		{
			std::vector<AnchorPoint*> list = GetOutputAnchorPoints();
		...
		ItemProperty SymbolOr::GetProperty(int index)
		{
		...
		void SymbolOr::SetProperty(int index, ItemProperty property_Renamed)
		{
			if (GetPropertyCount() > index && index >= 0)
			{
		...
		int SymbolOr::GetPropertyCount()
		{
			return 0;
		}

		FlowChart::Data::ISymbolChart *SymbolOr::GetInstance()
		{
			return new SymbolOr();
		}

		FlowChart::Data::ISymbolChart *SymbolOr::GetDuplicate()
		{
			SymbolOr *duplictate = new SymbolOr();
		...
		void SymbolOr::RotateAnchorPoints()
		{
		...
		winrt::hstring SymbolOr::GetString()
		{
			return L"Or";
		}

		winrt::hstring SymbolOr::GetTypeString()
		{
			return L"SymbolOr";
		}

		winrt::hstring SymbolOr::ToString()
		{
