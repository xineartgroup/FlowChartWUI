...
namespace winrt::FlowChartWUI::implementation
{
    ...
    struct __declspec(empty_bases) MainWindow_base : implements<D, FlowChartWUI::MainWindow, composing, I...>,
        impl::require<D, winrt::Microsoft::UI::Xaml::IWindow>,
        impl::base<D, winrt::Microsoft::UI::Xaml::Window>
    {
        using base_type = MainWindow_base;
        using class_type = FlowChartWUI::MainWindow;
        ...
        {
            return L"FlowChartWUI.MainWindow";
        }
        MainWindow_base()
        {
...
namespace winrt::FlowChartWUI::factory_implementation
{
    ...
    {
        using instance_type = FlowChartWUI::MainWindow;
